# Generated by Django 5.0.4 on 2024-10-12 05:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(1, 'Có mặt'), (2, 'Đi muộn'), (2, 'Vắng mặt')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='devices', to='rooms.room')),
            ],
        ),
    ]
